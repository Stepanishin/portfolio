...
const ProjectList = [
    ...
    },
    {
        ...
        description: 'Very convenient and bright web site in Cyberpunk style for DustCity company. I wrote my own animation for the site and many other interesting solutions',
...
const Item: FC<ItemProps> = ({title, description, stack, img, websiteLink,codeLink}) => {
